      ...
      <section className="relative pt-20 pb-32 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-cover">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
          <motion.div
            ...
            className="border border-indigo-600 p-2 w-72 mx-auto rounded-full flex items-center justify-between mb-8 bg-white bg-opacity-80 backdrop-filter backdrop-blur-sm"
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              href="#"
              className="w-8 h-8 rounded-full flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 transition-colors duration-300"
            >
          ...
          >
            ...
            <span className="text-indigo-600 ml-2 relative">
              Neighbourly
              <motion.span
                className="absolute -bottom-1 left-0 w-full h-1 bg-indigo-600"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
          ...
          {!user && (
            ...
            >
              <Link to="/register" className="flex-1 font-bold text-xl bg-white px-6 py-3 rounded-xl hover:bg-indigo-50 transition-colors duration-300 shadow-md hover:shadow-xl">
                Sign Up / Sign In
              </Link>
            </motion.div>
          )}
